...
add_action( 'wpcf7_init', 'cellep_wpcf7_add_shortcode_checkbox' );

function cellep_wpcf7_add_shortcode_checkbox() {
	wpcf7_add_shortcode( array( 'checkbox', 'checkbox*', 'radio' ),
		'cellep_wpcf7_checkbox_shortcode_handler', true );
}

function cellep_wpcf7_checkbox_shortcode_handler( $tag ) {
	...
	$html = sprintf(
		'<span class="wpcf7-form-control-wrap boolean-input %1$s"><span %2$s>%3$s</span>%4$s</span>',
...
add_filter( 'wpcf7_validate_checkbox', 'cellep_wpcf7_checkbox_validation_filter', 10, 2 );
add_filter( 'wpcf7_validate_checkbox*', 'cellep_wpcf7_checkbox_validation_filter', 10, 2 );
add_filter( 'wpcf7_validate_radio', 'cellep_wpcf7_checkbox_validation_filter', 10, 2 );

function cellep_wpcf7_checkbox_validation_filter( $result, $tag ) {
	$tag = new WPCF7_Shortcode( $tag );
...
add_filter( 'wpcf7_posted_data', 'cellep_wpcf7_checkbox_posted_data' );

function cellep_wpcf7_checkbox_posted_data( $posted_data ) {
...
if ( is_admin() ) {
	add_action( 'admin_init', 'cellep_wpcf7_add_tag_generator_checkbox_and_radio', 30 );
}

function cellep_wpcf7_add_tag_generator_checkbox_and_radio() {
	$tag_generator = WPCF7_TagGenerator::get_instance();
	$tag_generator->add( 'checkbox', __( 'checkboxes', 'contact-form-7' ),
		'cellep_wpcf7_tag_generator_checkbox' );
	$tag_generator->add( 'radio', __( 'radio buttons', 'contact-form-7' ),
		'cellep_wpcf7_tag_generator_checkbox' );
}

function cellep_wpcf7_tag_generator_checkbox( $contact_form, $args = '' ) {
